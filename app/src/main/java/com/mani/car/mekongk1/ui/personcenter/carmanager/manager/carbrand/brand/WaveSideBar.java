...
public class WaveSideBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextColor = Color.parseColor("#A6A6A6");
        mWaveColor = Color.parseColor("#bef9b81b");
        mTextColorChoose = ContextCompat.getColor(context, android.R.color.white);
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.dp_15);
        mHintTextSize = context.getResources().getDimensionPixelSize(R.dimen.dp_15);
        ...
        if (attrs != null) {
            ...
            mRadius = a.getDimensionPixelSize(R.styleable.waveSideBar_radius, context.getResources().getDimensionPixelSize(R.dimen.dp_3));
            mCircleRadius = a.getDimensionPixelSize(R.styleable.waveSideBar_circleRadius, context.getResources().getDimensionPixelSize(R.dimen.dp_3));
            a.recycle();
        }
