...
public class ControlButtonSingleZhu  extends RelativeLayout {
    ...
    public ControlButtonSingleZhu(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        dp5= ODipToPx.dipToPx(context,5 );
        initEvent();
    }
    private void initEvent(){
     buttonTouch(btn_01);
        buttonTouch(btn_02);
        buttonTouch(btn_03);
//        btn_01.setOnClickListener(new OnClickListenerMy(){
//            @Override
//            public void onClickNoFast(View v) {
//                DataControlButton button= (DataControlButton) v.getTag();
//                ControlControlFuncZhu.getInstance().controlButtonPress(button.ide,button.isUse,v);
//            }
//        });
//        btn_02.setOnClickListener(new OnClickListenerMy(){
//            @Override
//            public void onClickNoFast(View v) {
//                DataControlButton button= (DataControlButton) v.getTag();
//                ControlControlFuncZhu.getInstance().controlButtonPress(button.ide,button.isUse,v);
//            }
//        });
//        btn_03.setOnClickListener(new OnClickListenerMy(){
//            @Override
//            public void onClickNoFast(View v) {
//                DataControlButton button= (DataControlButton) v.getTag();
//                ControlControlFuncZhu.getInstance().controlButtonPress(button.ide,button.isUse,v);
...
//        });
    ...
    @SuppressLint("ClickableViewAccessibility")
    private void buttonTouch(Button button){
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()&event.getActionMasked()){
                    ...
                    case MotionEvent.ACTION_MOVE:
                         actionMoveY= event.getRawY();
                        break;
                    case MotionEvent.ACTION_UP:
                         actionUpY= event.getRawY();
                        Log.e("178", "onTouch: "+ "actionDownY=="+ actionDownY+"actionMoveY=="+ actionMoveY+"actionUpY=="+ actionUpY);
                        if((actionUpY-actionDownY)>=0){
                            DataControlButton button= (DataControlButton) v.getTag();
                            ControlControlFuncZhu.getInstance().controlButtonPress(button.ide,button.isUse,v);
                        }else{
                                PopChangeButtons.getInstance().show(v);
                        }
                        break;
                }
                return true;
