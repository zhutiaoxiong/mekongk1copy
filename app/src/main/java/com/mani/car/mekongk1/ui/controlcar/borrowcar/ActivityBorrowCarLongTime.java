...
public class ActivityBorrowCarLongTime extends BaseMvpActivity<BorrowCarView, BorrowCarPresenter> implements BorrowCarView,OEventObject {
...
//    ImageView img_delete;
    @BindView(R.id.trust_object)
    LeftTextRightEdit trust_object;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_borrow_car_long_time);
...
//        });
        btn_confirm.setOnClickListener(new OnClickListenerMy() {
            @Override
            public void onClickNoFast(View v) {
                String phoneNum=trust_object.txt_center.getText().toString();
...
//        setIsNeedPhoneNum(0);
        trust_object.txt_center.setInputType(InputType.TYPE_CLASS_PHONE);
        trust_object.txt_center.setFilters(new InputFilter[]{new InputFilter.LengthFilter(11)});
        txt_tip_content.setVisibility(View.VISIBLE);
        txt_tip_content.setText(OConver.StrToDBC("对方有下载并注册了么控K1账号，可以直接输入\n对方账号，进行信任授权使用车辆。"));
    }
