...
/**
 * 侧滑删除listView,详情看sample
 */
public class SwipeAndPullRefreshListView extends ListViewPushRefresh {
    ...
    public SwipeAndPullRefreshListView(Context context) {
        super(context);
    }
    public SwipeAndPullRefreshListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public SwipeAndPullRefreshListView(Context context, AttributeSet attrs, int defStyle) {
