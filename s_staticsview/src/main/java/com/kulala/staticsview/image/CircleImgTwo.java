...
public class CircleImgTwo extends ImageView {
    ...
    public CircleImgTwo(Context context) {
        super(context);
    }

    public CircleImgTwo(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleImgTwo(Context context, AttributeSet attrs, int defStyle) {
