 ...
 *  Presenter工厂实现类
 */
public class PresenterMvpFactoryImpl<V extends BaseMvpMethod, P extends BaseMvpPresenter<V>> implements PresenterMvpFactory<V, P> {
     ...
     * @return 工厂类
     */
    public static <V extends BaseMvpMethod, P extends BaseMvpPresenter<V>> PresenterMvpFactoryImpl<V,P> createFactory(Class<?> viewClazz){
