package com.kulala.timepicker.lib;
...
import com.kulala.timepicker.adapter.WheelAdapter;
import com.kulala.timepicker.listener.OnItemSelectedListener;
import com.kulala.timepicker.model.IPickerViewData;
...
//        canvas.drawBitmap(((BitmapDrawable)getContext().getDrawable(R.drawable.split_line)).getBitmap(),0.0F, firstLineY,paintIndicator);
//        canvas.drawBitmap(((BitmapDrawable)getContext().getDrawable(R.drawable.split_line)).getBitmap(),0.0F, secondLineY,paintIndicator);
        //单位的Label
        if (label != null) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                String contentText = getContentText(visibles[counter])+adapter.getBackStr();
